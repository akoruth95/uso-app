  ...
  <div>
      ...
      <v-flex d-flex xs12 sm6 md4>
       <v-card>
        <v-flex text-xs-center>
          ...
          <div align="center" >
            <star-rating align="center" :star-size="20" :show-rating="false" active-color="yellow" @rating-selected="setSatisfactionRating"></star-rating> 
          </div>
        </v-flex>
       </v-card>
      </v-flex>
      ...
      <v-flex d-flex xs12 sm6 md4>
       <v-card>
        <v-flex text-xs-center>
          ...
          <div align="center" >
            <star-rating align="center" :star-size="20" :show-rating="false" active-color="yellow" @rating-selected="setObjectivesRating"></star-rating>
          </div>
        </v-flex>
       </v-card>
      </v-flex>
      ...
      <v-flex d-flex xs12 sm6 md4>
       <v-card tile="true">
        <v-flex text-xs-center>
          ...
          <div align="center" >
            <star-rating align="center" :star-size="20" :show-rating="false" active-color="yellow" @rating-selected="setSuggestionRating"></star-rating>
          </div>
        </v-flex>
       </v-card>
      </v-flex>
    ...
    <v-dialog hide-overlay
      ...
      >
        <v-card>  
          <v-card-text>
            Thank you for your comments. Your feedback has been accepted.
          </v-card-text>
